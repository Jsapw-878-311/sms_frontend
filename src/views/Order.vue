...
<!--                    <span v-if="scope.row.platform == 0">smspool</span>-->
<!--                    <span v-else-if="scope.row.platform == 1">支付宝支付</span>-->
<!--                    <span v-else>未知</span>-->
<!--                </template>-->
<!--            </el-table-column>-->
...
<!--                &lt;!&ndash;                    <span>{{ $filters.orderMap(scope.row.orderStatus) }}</span>&ndash;&gt;-->
...
<!--            &lt;!&ndash;                    prop="payType"&ndash;&gt;-->
<!--            &lt;!&ndash;                    label="支付方式">&ndash;&gt;-->
<!--            &lt;!&ndash;                <template #default='scope'>&ndash;&gt;-->
<!--            &lt;!&ndash;                    <span v-if="scope.row.payType == 1">微信支付</span>&ndash;&gt;-->
<!--            &lt;!&ndash;                    <span v-else-if="scope.row.payType == 2">支付宝支付</span>&ndash;&gt;-->
<!--            &lt;!&ndash;                    <span v-else>未知</span>&ndash;&gt;-->
<!--            &lt;!&ndash;                </template>&ndash;&gt;-->
<!--            &lt;!&ndash;            </el-table-column>&ndash;&gt;-->
...
<!--&lt;!&ndash;                            v-if="scope.row.orderStatus == 1"&ndash;&gt;-->
<!--&lt;!&ndash;                            title="确定配货完成吗？"&ndash;&gt;-->
<!--&lt;!&ndash;                            @confirm="handleConfig(scope.row.orderId)"&ndash;&gt;-->
<!--&lt;!&ndash;                            confirm-button-text="确定"&ndash;&gt;-->
<!--&lt;!&ndash;                            cancel-button-text="取消"&ndash;&gt;-->
<!--&lt;!&ndash;                    >&ndash;&gt;-->
<!--&lt;!&ndash;                        <template #reference>&ndash;&gt;-->
<!--&lt;!&ndash;                            <a style="cursor: pointer; margin-right: 10px">配货完成</a>&ndash;&gt;-->
<!--&lt;!&ndash;                        </template>&ndash;&gt;-->
<!--&lt;!&ndash;                    </el-popconfirm>&ndash;&gt;-->
<!--&lt;!&ndash;                    <el-popconfirm&ndash;&gt;-->
<!--&lt;!&ndash;                            v-if="scope.row.orderStatus == 2"&ndash;&gt;-->
<!--&lt;!&ndash;                            title="确定出库吗？"&ndash;&gt;-->
<!--&lt;!&ndash;                            @confirm="handleSend(scope.row.orderId)"&ndash;&gt;-->
<!--&lt;!&ndash;                            confirm-button-text="确定"&ndash;&gt;-->
<!--&lt;!&ndash;                            cancel-button-text="取消"&ndash;&gt;-->
<!--&lt;!&ndash;                    >&ndash;&gt;-->
<!--&lt;!&ndash;                        <template #reference>&ndash;&gt;-->
<!--&lt;!&ndash;                            <a style="cursor: pointer; margin-right: 10px">出库</a>&ndash;&gt;-->
<!--&lt;!&ndash;                        </template>&ndash;&gt;-->
<!--&lt;!&ndash;                    </el-popconfirm>&ndash;&gt;-->
<!--&lt;!&ndash;                    <el-popconfirm&ndash;&gt;-->
<!--&lt;!&ndash;                            v-if="!(scope.row.orderStatus == 4 || scope.row.orderStatus < 0)"&ndash;&gt;-->
<!--&lt;!&ndash;                            title="确定关闭订单吗？"&ndash;&gt;-->
<!--&lt;!&ndash;                            @confirm="handleClose(scope.row.orderId)"&ndash;&gt;-->
<!--&lt;!&ndash;                            confirm-button-text="确定"&ndash;&gt;-->
<!--&lt;!&ndash;                            cancel-button-text="取消"&ndash;&gt;-->
<!--&lt;!&ndash;                    >&ndash;&gt;-->
<!--&lt;!&ndash;                        <template #reference>&ndash;&gt;-->
<!--&lt;!&ndash;                            <a style="cursor: pointer; margin-right: 10px">关闭订单</a>&ndash;&gt;-->
<!--&lt;!&ndash;                        </template>&ndash;&gt;-->
<!--&lt;!&ndash;                    </el-popconfirm>&ndash;&gt;-->
<!--&lt;!&ndash;                    <router-link :to="{ path: '/order_detail', query: { id: scope.row.orderId }}">订单详情</router-link>&ndash;&gt;-->
<!--&lt;!&ndash;                </template>&ndash;&gt;-->
<!--&lt;!&ndash;            </el-table-column>&ndash;&gt;-->
<!--        </el-table>-->
<!--        <el-pagination-->
